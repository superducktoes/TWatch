...
const int maxApp = 13; // number of apps
String appName[maxApp] = {"Clock", "Jupiter", "Accel", "Battery", "Touch", "Set Time", "Motor", "Temp", "Bitcoin", "Int Time", "Exper", "Wifi Scan", "WiFi Sniff"}; // app names
